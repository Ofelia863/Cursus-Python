...
print("Test 1: getal = 2.5")
test_output(oefening_path, "1.25", "2.5")
...
print("Test 1: getal = -2.1")
test_output(oefening_path, "-1.05", "-2.1")


print("Test 1: getal = -3")
test_output(oefening_path, "-1.5", "-3")

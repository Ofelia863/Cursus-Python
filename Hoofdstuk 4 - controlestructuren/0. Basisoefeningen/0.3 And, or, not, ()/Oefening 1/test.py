...
test_output(oefening_path, "4 is een strikt positief, even getal", "4")
test_output(oefening_path, "", "1")
test_output(oefening_path, "", "-4")
test_output(oefening_path, "", "0")
test_output(oefening_path, "6 is een strikt positief, even getal", "6")
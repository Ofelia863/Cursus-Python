...
test_output(oefening_path, "Positief", "11")
test_output(oefening_path, "Positief", "1")
test_output(oefening_path, "Positief", "0")
test_output(oefening_path, "Negatief", "-1")
test_output(oefening_path, "Negatief", "-4")